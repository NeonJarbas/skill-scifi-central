...
class SciFiCentralSkill(OVOSCommonPlaybackSkill):
    ...
    def __init__(self):
        super().__init__("SciFiCentral")
        self.supported_media = [MediaType.MOVIE, MediaType.GENERIC]
        self.skill_icon = join(dirname(__file__), "ui", "scificentral_icon.jpg")
        self.archive = YoutubeMonitor(db_name="SciFiCentral",
                                      min_duration=30 * 60,
                                      logger=LOG,
    ...
    def initialize(self):
        url = "https://www.youtube.com/channel/UCOpzwVUNsep7FpN5687XYEA"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "scificentral"):
